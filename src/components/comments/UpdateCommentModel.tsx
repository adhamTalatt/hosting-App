...
const UpdateCommentModel = ({
  ...
  async function formSubmitHandle(e: FormEvent) {
    e.preventDefault();
    ...
    <div className=" fixed top-0 left-0 bottom-0 right-0 z-10 bg-black bg-opacity-40 flex items-center justify-center">
      <div className="w-11/12 lg:w-2/4  bg-white rounded-lg p-3 ">
        ...
        <form onSubmit={formSubmitHandle}>
          ...
          <button
            type="submit"
            className="bg-[#405D72] w-full text-white  mt-2 p-1 text-xl rounded-lg hover:bg-green-900 transition duration-200 "
          >
            Edit
          </button>
        </form>
